...
public class LinkedListMap<K, V> implements Map<K, V> {
	...
	public void put(K key, V value) {
		...
		/* We could test whether containsKey returns true, but it would iterate 
		 * over the list, only to iterate again when we invoke remove.
		 * remove doesn't throw an exception if the key isn't there, so just call it. */
